...
import pandas as pd
from edge_flow_cell_complexes import CellComplexDetectionExperiment
...
cells = literal_eval(cell_compl_file.read())
node_count = len([ c for c in cells if len(c) == 1])
realworld_complex = CellComplex(node_count, cells)
